...
# define file name
CLMndep_file = os.environ.get('USERWORK')+'/isimip_forc/Ohter_modified_files/fndep_clm_f09_g17.CMIP6-SSP3-7.0-WACCM_1849-2101_monthly_ESM2025.nc'
isimipndep_file_ =  os.environ.get('USERWORK')+'/isimip_forc/Ohter_modified_files/ndep_isimip_ssp370_0.9x1.25_2015_2100_days.nc'

# copy and remap files with separate shell scrip
subprocess.call("./CopyAndRemapNDEP_ssp370.sh", shell=True) 
